...
import procesos.ProcesosTipoCuenta;
import javax.swing.table.DefaultTableModel;
import javax.swing.table.DefaultTableCellRenderer;
public class FormTipoCuenta extends javax.swing.JInternalFrame {
    private TipoCuenta tipoCuenta;
    private ProcesosTipoCuenta procesos;
    private DefaultTableModel modelo = new DefaultTableModel();
    private String accion;
    /**
     * Creates new form FormTipoCuenta
     */
    public FormTipoCuenta() {
        tipoCuenta = new TipoCuenta();
        procesos = new ProcesosTipoCuenta();
        modelo = null;
        accion = "";
        initComponents();
    ...
    public void agregar(){
        try{
            if(txtNombre.getText().isEmpty()){//si esta vacio
                ...
                tipoCuenta.setIdTipoCuenta(0);
                tipoCuenta.setNombre(txtNombre.getText());
                
                int r = procesos.agregar(tipoCuenta);
                if(r == 1){
                    JOptionPane.showMessageDialog(this, "Tipo de cuenta agregado con exito.");
                    limpiar();
                    habilitarCampos(false);
                    btnAgregar.setEnabled(true);
                    btnModificar.setEnabled(true);
        ...
        if(txtId.getText().equals("")){
            ...
            try {
                if(txtNombre.getText().isEmpty()){
                    ...
                    tipoCuenta.setIdTipoCuenta(Integer.parseInt(txtId.getText()));
                    tipoCuenta.setNombre(txtNombre.getText());
                    
                    int r = procesos.modificar(tipoCuenta);
                    if (r == 1){
                        JOptionPane.showMessageDialog(this, "Tipo de cuenta modificado con exito.");
                        limpiar();
                        habilitarCampos(false);
                        btnAgregar.setEnabled(true);
                        btnModificar.setEnabled(true);
    ...
    private void listar(JTable tabla){
        ...
        List<TipoCuenta> lista = procesos.listar();
        Object[] objeto = new Object[8];
        for (int i = 0; i < lista.size(); i++){
            objeto[0] = lista.get(i).getIdTipoCuenta();
